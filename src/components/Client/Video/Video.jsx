...
const Video = () => {
  ...
  return (
    <div className="relative d:pt-10 p:pt-0 min-h-screen bg-gradient-to-br from-blue-800 to-blue-300 text-white">
      ...
      {isVideo && (
        <div className="w-full h-screen absolute p:-top-[90px] d:-top-[128px] bg-[rgba(0,0,0,0.8)] flex justify-center items-center z-[9999]">
          <>
